...
// Profile is the blue-team scenario profile. v3 metadata-only differentiation:
...
func (p *Profile) Name() string                { return "blue-team" }
...
func (p *Profile) Metadata() profiles.Metadata {
	return profiles.Metadata{
		Name:        "blue-team",
		Label:       "Blue Team",
		Description: "Defensive ops cluster.",
		Accent:      "sky",
		Tag:         "SCENARIO",
		Icon:        "eye",
		Enabled:     true,
